        ...
        <div className='my-6'>
            <div className="w-full mx-auto max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="my-6 space-y-4">
                    <button onClick={signinWithGoogle} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
                ...
                <p className="text-sm text-center mt-4 dark:text-gray-600">Don't have account?
                    <NavLink to={'/auth/signup'} className="focus:underline text-blue-400 hover:underline">SignUp here</NavLink>
                </p>
            </div>
        </div>
    );
