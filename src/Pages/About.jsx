    ...
    return (
        <div className="flex flex-col items-center min-h-screen p-4 ">
            <div className="max-w-3xl w-full">
                <h1 className="text-4xl md:text-5xl font-bold  text-center mb-6">About Recipe Book</h1>
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl md:text-3xl text-center font-semibold mb-4">Frequently Asked Questions</h2>
                    {/* Accordion Part */}
